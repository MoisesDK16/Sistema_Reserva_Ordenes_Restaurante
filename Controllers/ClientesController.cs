...
namespace Restaurante_Moises_Loor.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Correo,Telefono")] Cliente usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Correo,Telefono")] Cliente usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
